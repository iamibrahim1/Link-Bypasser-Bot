...
# bot
bot_token = os.environ.get("TOKEN", "6038893670:AAGRdEO48G5lpULmKMh8sVlouzifqRmx4fw")
api_hash = os.environ.get("HASH", "96e150cdf7b9f5c4d960add8be4debb3") 
api_id = os.environ.get("ID", "22524363")
...
def send_start(client: pyrogram.client.Client, message: pyrogram.types.messages_and_media.message.Message):
    ...
    reply_markup=InlineKeyboardMarkup([[ InlineKeyboardButton("🌐 Join", url="https://telegram.dog/reax13xx")]]), reply_to_message_id=message.id)
